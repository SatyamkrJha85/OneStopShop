...
public class LatestProducts {
    ...
    public LatestProducts(String pID, int catID, String pName, String pDetails, int price, String color, String brand, String manufacturer, String countryOrigin, String image) {
        this.pID = pID;
        this.catID = catID;
        this.pName = pName;
