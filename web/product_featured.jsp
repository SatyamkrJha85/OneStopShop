...
<%
    ...
    FeaturedProducts w = pd.getFeaturedProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/featuredproducts/<%=w.getImage()%>" alt=""></div>
                <div class="details">
                    ...
                    <table class="table" >
                        ...
                        <tr  class="row">
                            ...
                            <td class="col"><%=w.getBrand()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Manufacturer</td>
                            <td class="col"> <%=w.getManufacturer()%></td>
                        </tr>
                        <tr  class="row">
