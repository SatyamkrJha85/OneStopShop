...
<%
    ...
    List<Electronics> electronics = pd.getElectronics();
%>
...
<html lang="en">
    ...
    <body>
        ...
        <div id="banner" style="background-image: url('./Resources/category/electronics/banner.jpg');"></div>

        <!--products-->
        <%            if (!electronics.isEmpty()) {
                for (Electronics m : electronics) {
        %>

        <div class="item">
            <a href="product_electronics.jsp?productId=<%= m.getpID()%>" style="display:flex">
                <div class="product1" style="background-image: url('./Resources/category/electronics/<%= m.getImage()%>');"></div>
                <div id=text>
