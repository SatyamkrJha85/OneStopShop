...
<html lang="en">
    ...
    <body>
        ...
        <div id="banner" style="background-image: url('./Resources/category/footwear/banner.jpg');"></div>
        ...
        %>
        <div class="item">
            <a href="product_footwear.jsp?productId=<%= m.getpID()%>" style="display:flex">
                <div class="product1" style="background-image: url('./Resources/category/footwear/<%= m.getImage()%>');"></div>
                <div id=text>
