...
<%
    ...
    Jewellery w = pd.getJewelleryProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/category/jewellery/<%=w.getImage()%>" alt=""></div>
                <div class="details">
                    ...
                    <table class="table" >
                        ...
                        <tr class="row">
                            <td class="bold">Clasp type</td>
                            <td class="col"><%=w.getClaspType()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Material type</td>
                            <td class="col"><%=w.getMaterialType()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Metal type</td>
                            <td class="col"> <%=w.getMetalType()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold" >Gem type</td>
                            <td class="col"><%=w.getGemType()%></td>
                        </tr>
                    </table>
                    <div>
