...
<html lang="en">
    ...
    <body>
        ...
        <div id="banner" style="background-image: url('./Resources/category/jewellery/banner.jpg');"></div>
        ...
        %>
        <div class="item">
            <a href="product_jewellery.jsp?productId=<%= m.getpID()%>" style="display:flex">
                <div class="product1" style="background-image: url('./Resources/category/jewellery/<%= m.getImage()%>');"></div>
                <div id=text>
