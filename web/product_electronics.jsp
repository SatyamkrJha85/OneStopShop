...
<%
    ...
    Electronics w = pd.getElectronicProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/category/electronics/<%=w.getImage()%>" alt=""></div>
                <div class="details">
                    ...
                    <table class="table" >
                        ...
                        <tr  class="row">
                            ...
                            <td class="col"><%=w.getWeight()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Warranty</td>
                            <td class="col"> <%=w.getWarranty()%></td>
                        </tr>
                        <tr  class="row">
