...
<%@page import="com.one.stop.shop.entities.Women"%>
...
<%
    ...
    Women w = pd.getWomenProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/category/women/<%=w.getImage()%>" alt=""></div>
                <div class="details">
