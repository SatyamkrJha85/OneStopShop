...
<%
    ...
    Footwear w = pd.getFootwearProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/category/footwear/<%=w.getImage()%>" alt=""></div>
                <div class="details">
                    ...
                    <table class="table" >
                        ...
                        <tr class="row">
                            <td class="bold">Outer material</td>
                            <td class="col"><%=w.getOuterMaterial()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">For</td>
                            <td class="col"><%=w.getpFor()%></td>
                        </tr>
                        <tr  class="row">
                        ...
                        <tr  class="row">
                            <td class="bold" >Occasion</td>
                            <td class="col"><%=w.getOccasion()%></td>
                        </tr>
                    </table>
                    <div>
                        <%
