...
<%@page import="com.one.stop.shop.entities.Login"%>
<%@page import="com.one.stop.shop.dao.LoginDao"%>
        ...
        <div class="container">
            ...
            <aside>
                ...
                <div class="sidebar">
                    ...
                    <a href="loginuser.jsp" class="Dashboard">
            ...
            <main>
                ...
                <div class="loginuser">
                    ...
                    <table>
                        ...
                        <tbody>
                            <%
                                LoginDao ld = new LoginDao((OracleConnection) ConnectionProvider.getConnection());
                                List<Login> log = ld.getLogin();
                            %>
                            <%
                                if (!log.isEmpty()) {
                                    for (Login m : log) {
