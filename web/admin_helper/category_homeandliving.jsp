...
<%
    ...
    List<HomeAndLiving> hl = pd.getHomeAndLiving();
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="item">
            ...
            <div class="mid" style="height:20rem; padding-top:2.3rem;">
                <ul id=text>
                    ...
                    <li><strong>Color:</strong> <%=m.getColor()%></li>
                    <li><strong>Material:</strong> <%=m.getMaterial()%></li>
                    <li><strong>Use:</strong> <%=m.getUse()%></li>
                    <li><strong>Country origin:</strong>  <%=m.getCountryOrigin()%></li>
        ...
        <div id="last">
            ...
            <a href="http://localhost:8080/OneStopShop/AdminRemoveProductServlet?pid=<%=m.getpID()%>&cid=5">
