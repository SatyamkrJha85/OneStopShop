...
<%
    ...
    List<Electronics> el = pd.getElectronics();
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="item">
            ...
            <div class="mid" style="height:20rem; padding-top:2.3rem;">
                <ul id=text>
                    ...
                    <li><strong>Weight:</strong> <%=m.getWeight()%></li>
                    <li><strong>Warranty: </strong> <%=m.getWarranty()%></li>
        ...
        <div id="last">
            ...
            <a href="http://localhost:8080/OneStopShop/AdminRemoveProductServlet?pid=<%=m.getpID()%>&cid=6">
