...
<%@page import="com.one.stop.shop.entities.Feedback"%>
        ...
        <div class="container">
            ...
            <aside>
                ...
                <div class="sidebar">
                    ...
                    <a href="userfeedback.jsp"  class="Dashboard">
            ...
            <main>
                ...
                <div class="signupuser">
                    ...
                    <table>
                        ...
                        <tbody>
                            <%
                                SecondaryDao sd1 = new SecondaryDao((OracleConnection) ConnectionProvider.getConnection());
                                List<Feedback> com1 = sd1.getFeedback();
                                if (!com1.isEmpty()) {
                                    for (Feedback c1 : com1) {
                            %>
                            <tr>                   
                                <td><%=c1.getEmail()%></td>  
                                <td><%=c1.getSubject()%></td>                     
