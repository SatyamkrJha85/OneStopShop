...
<html lang="en">
    ...
    <body>
        ...
        <!-- product -->
        <div class="item">
            <div id="product-id"><p>#<%=m.getpID()%></p></div>
            ...
            <div class="mid" style="height:20rem; padding-top:2.3rem;">
                <ul id=text>
                    ...
                    <li><strong>Sleeve:</strong> <%=m.getSleeve()%></li>
                    <li><strong>Fit:</strong> <%=m.getFit()%></li>
                    <li><strong>Type:</strong> <%=m.getType()%></li>
                    <li><strong>Fabric:</strong>  <%=m.getFabric()%></li>
            ...
            <div id="last">
                ...
                <a href="http://localhost:8080/OneStopShop/AdminRemoveProductServlet?pid=<%=m.getpID()%>&cid=1">
