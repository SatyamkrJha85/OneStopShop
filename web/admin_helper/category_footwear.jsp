...
<%
    ...
    List<Footwear> footwear = pd.getFootwear();
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="item">
            ...
            <div class="mid" style="height:20rem; padding-top:2.3rem;">
                <ul id=text>
                    ...
                    <li><strong>Material:</strong> <%=m.getOuterMaterial()%></li>
                    <li><strong>For:</strong> <%=m.getpFor()%></li>
                    <li><strong>Type:</strong> <%=m.getType()%></li>
                    <li><strong>Occasion:</strong>  <%=m.getOccasion()%></li>
        ...
        <div id="last">
            ...
            <a href="http://localhost:8080/OneStopShop/AdminRemoveProductServlet?pid=<%=m.getpID()%>&cid=3">
