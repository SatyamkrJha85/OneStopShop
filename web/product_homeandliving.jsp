...
<%
    ...
    HomeAndLiving w = pd.getHomeAndLivingProducts(productId);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin:2rem;">
            <div class="main">
                <div  class="img" ><img class="mimg" src="./Resources/category/homeandliving/<%=w.getImage()%>" alt=""></div>
                <div class="details">
                    ...
                    <table class="table" >
                        ...
                        <tr class="row">
                            ...
                            <td class="col"><%=w.getColor()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Material</td>
                            <td class="col"><%=w.getMaterial()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold">Use</td>
                            <td class="col"> <%=w.getUse()%></td>
                        </tr>
                        <tr  class="row">
                            <td class="bold" >Country Origin</td>
                            <td class="col"><%=w.getCountryOrigin()%></td>
                        </tr>
                    </table>
                    <div>
                        <%
